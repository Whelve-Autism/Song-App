...
public class Display {
    ...
    public static void beginDisplay() {
        middleSlash();
        printlnRandomColor("Song App V6.0");
        printlnRandomColor("Developed by Fan Xinkang.");
        printlnRandomColor("The program starts at: " + getLocalDateTime() + ".");
        middleSlash();
        System.out.println();
        printlnRandomColor("Attention: For some reason, functions 5, 6 and 7 cannot be used. For specific details, please refer to the Description document.");
        ScannerInput.readNextLine("Pressing the Enter key means that you have known the above situation.");
    ...
    public static void endDisplay() {
        ...
        printlnRandomColor("Thank you for using my Song App.");
