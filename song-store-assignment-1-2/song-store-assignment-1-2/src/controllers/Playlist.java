...
//    }
    ...
    public String listOfSongsOfArtist(String artistName) {
        ...
        for (int i = 0; i < songs.size(); i++) {
            if (songs.get(i).getArtistName().equals(artistName)) {
                builder.append(i).append(": ").append(songs.get(i).toString()).append("\n");
                isArtistSong = true;
            }
        }
...
//    }
    ...
    public String searchSongsByArtistName(String artistName) {
        ...
        for (int i = 0; i < songs.size(); i++) {
            if (songs.get(i).getArtistName().contains(artistName)) {
                builder.append(songs.get(i).getName()).append(" (").append(songs.get(i).getSongId()).append(")\n");
                isArtistName = true;
            }
        }
        if (isArtistName) {
